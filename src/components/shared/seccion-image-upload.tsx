...
interface SeccionImageUploadProps {
  value: string
...
export function SeccionImageUpload({
  value,
  onChange,
  onRemove,
  label = 'Imagen',
}: SeccionImageUploadProps) {
    ...
    <div className="flex items-center gap-4">
      <div className="relative">
        <Avatar className="h-24 w-24 rounded-lg border bg-background">
          <AvatarImage src={value} alt={label} className="object-contain p-2" />
      ...
      <div className="flex-1">
        <label htmlFor="seccion-image-upload">
          <Button
            type="button"
            variant="outline"
