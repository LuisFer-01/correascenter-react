...
interface ServicioImageUploadProps {
  value: string
...
export function ServicioImageUpload({
  value,
  onChange,
  onRemove,
  serviceName,
}: ServicioImageUploadProps) {
    ...
    <div className="flex items-center gap-4">
      <div className="relative">
        <Avatar className="h-24 w-24 rounded-lg border bg-background">
          <AvatarImage src={value} alt={serviceName || 'Servicio'} className="object-contain p-2" />
      ...
      <div className="flex-1">
        <label htmlFor="servicio-image-upload">
          <Button
            type="button"
            variant="outline"
